...
excerpt: 'Academic CV 不是工作简历的延伸，它有自己的格式逻辑和评审重点。这篇文章拆解经济学 PhD 申请 CV 的结构、内容取舍和常见错误。'
category: PhD 申请
tags:
  - cv
  - phd-applications
...
metadata:
  title: 'Academic CV 怎么写？经济学 PhD 申请简历完整指南 | Best Studio'
  description: '经济学 PhD 申请 CV 应该写什么？Academic CV 和工作简历有什么区别？这篇文章拆解学术简历的结构、内容取舍和格式要求。'
---
...
这篇文章专门针对经济学 PhD 申请的 CV，拆解它的结构和内容逻辑。CV 在整个申请材料里的地位，可以对照[PhD 申请时间线](/guides/phd-application-timeline)来理解。
...
因此 CV 的核心逻辑是：用最清晰的方式，让委员会快速看到研究相关的证据。关于委员会在读什么信号，[推荐信：招生委员会真正看什么？](/guides/recommendation-letters)里有更完整的分析。
...
描述的重点是：你做了什么、用了什么方法、有什么具体贡献。关于哪种参与方式才算「有说服力的贡献」，参考[独立研究 vs 辅助工作](/guides/independent-research-vs-assistant)，而不是这个项目研究什么（那是教授的工作）。

**好的描述示例：**
「Constructed a panel dataset linking administrative records from X and Y; identified measurement discrepancies and proposed a matching algorithm, improving coverage by 12%.」

**弱的描述示例：**
「Assisted Professor X in her research on labor market outcomes of disadvantaged youth.」
...
不要夸大。「Proficient in Stata」和「Basic knowledge of Python」是两个不同的描述，要如实写。委员会有时会在 [PhD 面试](/guides/phd-interview-prep) 里问技术问题。
...
参加过的学术会议（如果是 presenter 而不只是参会者）、TA 经历（放在研究经历之后）、与研究相关的工作经历。Predoc 经历同样放在研究经历栏，参考[什么是 Predoc？](/guides/predoc-complete-guide)里对职责描述的建议。
...
**一个判断标准：** 这个条目能帮助委员会判断我的研究能力吗？如果答案是否定的，删掉。这个判断力标准和[独立研究 vs 辅助工作](/guides/independent-research-vs-assistant)里的核心逻辑一致。
...
委员会更关心你有没有在真实的研究项目里做过独立的判断，而不只是执行任务。技术能力是基础，但[研究经历的质量](/guides/research-experience-quality)才是重点。
...
最直接的解决方式：在提交申请之前，积累至少一段有实质内容的 RA 参与。这不一定是全职的，甚至可以是远程的、兼职的，只要有真实的指导教授、真实的项目、和真实的工作内容。具体怎么找，参考[如何找到第一段 RA 机会](/guides/how-to-find-first-ra-opportunity)。
